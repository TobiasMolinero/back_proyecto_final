...
import { comprobarGastoEliminado } from '../middlewares/gasto.middleware.js'

const router = Router()

router.get('/gastos/all', all)
router.get('/gastos/one/:id', one)
router.post('/gastos/create', comprobarGastoEliminado, crear)
router.put('/gastos/edit/:id', editar)
router.delete('/gastos/delete/:id', borrar)

//Categoria gasto
router.get('/cat-gastos/all', allCategorias)
router.post('/cat-gastos/create', crearCategoria)
